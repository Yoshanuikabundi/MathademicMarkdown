...
if sublime.version() < '3000':
    _ST3 = False
    from mm_utils import get_setting
    from mm_utils.external.frozendict import frozendict
    from mm_utils.six import unicode, long, strbase
    from mm_utils.system import make_dirs
    from mm_utils.utils import ThreadPool
else:
    _ST3 = True
