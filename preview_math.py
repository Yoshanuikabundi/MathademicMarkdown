...
from .mm_utils import cache, get_setting
from .mm_utils.external_command import execute_command
from .mm_utils.parseTeXlog import parse_tex_log
from .mm_utils import preview_utils
from .mm_utils.preview_utils import (
    ghostscript_installed, get_ghostscript_version, run_ghostscript_command)
from .mm_utils import preview_threading as pv_threading
...
class MathPreviewPhantomListener(sublime_plugin.ViewEventListener,
    ...
    def _create_document(self, scope, color):
        ...
        if (
            view.settings().get('syntax') == MathademicMarkdown
